...
#define FOCVMOC_MEMORY_PTR_cb_ptr GS_PTR struct eos_vm_oc_control_block* const cb_ptr = ((GS_PTR struct eos_vm_oc_control_block* const)(FOC_VM_OC_CONTROL_BLOCK_OFFSET));

int32_t eos_vm_oc_grow_memory(int32_t grow, int32_t max) {
   FOCVMOC_MEMORY_PTR_cb_ptr;
   ...
   current_gs += grow_amount * FOC_VM_OC_MEMORY_STRIDE;
