...
class memory {
      ...
      static_assert(sizeof(control_block) <= wcb_allowance, "FOC VM OC memory doesn't set aside enough memory for control block");
   ...
   public:
      ...
      static_assert(-cb_offset == FOC_VM_OC_CONTROL_BLOCK_OFFSET, "FOC VM OC control block offset has slid out of place somehow");
      static_assert(stride == FOC_VM_OC_MEMORY_STRIDE, "FOC VM OC memory stride has slid out of place somehow");
