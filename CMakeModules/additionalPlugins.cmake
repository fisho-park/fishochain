...
foreach(ADDITIONAL_PLUGIN_SOURCE_DIR ${FOC_ADDITIONAL_PLUGINS})
...
foreach(ADDITIONAL_PLUGIN_TARGET ${ADDITIONAL_PLUGINS_TARGET})
    target_link_libraries( nodefoc PRIVATE -Wl,${whole_archive_flag} ${ADDITIONAL_PLUGIN_TARGET} -Wl,${no_whole_archive_flag} )
endforeach()
