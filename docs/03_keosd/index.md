...
`keosd` is distributed as part of the [FOC software suite](https://github.com/FOC/eos/blob/master/README.md). To install `keosd` just visit the [FOC Software Installation](../00_install/index.md) section.
...
[[info | Audience]]
| `keosd` is intended to be used by FOC developers only.
