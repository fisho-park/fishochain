...
* [Configure Nodeos as a Local 21-Node Testnet](https://github.com/FOC/eos/blob/master/tutorials/bios-boot-tutorial/README.md)

## Third-Party Testnets

The following third-party testnets are available for testing FOC dApps and smart contracts:
