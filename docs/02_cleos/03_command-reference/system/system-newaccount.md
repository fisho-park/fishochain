...
- `--stake-net` _TEXT_ - The amount of FOC delegated for net bandwidth
- `--stake-cpu` _TEXT_  - The amount of FOC delegated for CPU bandwidth
- `--buy-ram-bytes` _UINT_ - The amount of RAM bytes to purchase for the new account in kilobytes KiB, default is 8 KiB
- `--buy-ram-FOC` _TEXT_ - The amount of RAM bytes to purchase for the new account in FOC
- `--transfer` - Transfer voting power and right to unstake FOC to receiver
