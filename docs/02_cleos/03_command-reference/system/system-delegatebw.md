...
- `stake_net_quantity` _TEXT_ - The amount of FOC to delegate for network bandwidth
- `stake_cpu_quantity` _TEXT_  - The amount of FOC to delegate for CPU bandwidth
