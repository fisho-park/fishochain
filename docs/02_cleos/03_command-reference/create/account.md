...
## Command
A set of FOC keys is required to create an account. A set of FOC keys can be generated by using `./cleos create key`.

```shell
$ ./cleos create account inita tester FOC4toFS3YXEQCkuuw1aqDLrtHim86Gz9u3hBdcBw5KNPZcursVHq FOC7d9A3uLe6As66jzN8j44TXJUqJSK3bFjjEEqR4oTvNAB3iM9SA
```
