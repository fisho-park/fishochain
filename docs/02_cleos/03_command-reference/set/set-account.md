...
```shell
$ ./cleos set account permission test active '{"threshold" : 1, "keys" : [{"permission":{"key":"FOC8X7Mp7apQWtL6T2sfSZzBcQNUqZB7tARFEm9gA9Tn9nbMdsvBB","permission":"active"},"weight":1}], "accounts" : [{"permission":{"account":"acc2","permission":"active"},"weight":50}]}' owner
```
...
```shell
$ ./cleos set account permission test active '{"threshold" : 100, "keys" : [{"permission":{"key":"FOC8X7Mp7apQWtL6T2sfSZzBcQNUqZB7tARFEm9gA9Tn9nbMdsvBB","permission":"active"},"weight":25}], "accounts" : [{"permission":{"account":"@sandwich","permission":"active"},"weight":75}]}' owner
```
...
```json
{
  ...
  "keys"            : [],     /*An array made up of individual permissions defined with an FOC PUBLIC KEY*/
  "accounts"        : []      /*An array made up of individual permissions defined with an FOC ACCOUNT*/
}
```
...
{
  "permission" : {
    "key"           : "FOC8X7Mp7apQWtL6T2sfSZzBcQNUqZB7tARFEm9gA9Tn9nbMdsvBB",
    "permission"    : "active"
  },
